...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineGroupPlacementStatus) DeepCopyInto(out *VirtualMachineGroupPlacementStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineGroupPlacementStatus.
func (in *VirtualMachineGroupPlacementStatus) DeepCopy() *VirtualMachineGroupPlacementStatus {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineGroupPlacementStatus)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VirtualMachineGroupPowerOp) DeepCopyInto(out *VirtualMachineGroupPowerOp) {
	*out = *in
	if in.Delay != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VirtualMachineGroupPowerOp.
func (in *VirtualMachineGroupPowerOp) DeepCopy() *VirtualMachineGroupPowerOp {
	if in == nil {
		return nil
	}
	out := new(VirtualMachineGroupPowerOp)
	in.DeepCopyInto(out)
	return out
}
...
func (in *VirtualMachineGroupSpec) DeepCopyInto(out *VirtualMachineGroupSpec) {
	*out = *in
	...
	if in.PowerOnOp != nil {
		in, out := &in.PowerOnOp, &out.PowerOnOp
		*out = make([]VirtualMachineGroupPowerOp, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.PowerOffOp != nil {
		in, out := &in.PowerOffOp, &out.PowerOffOp
		*out = make([]VirtualMachineGroupPowerOp, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
func (in *VirtualMachineGroupStatus) DeepCopyInto(out *VirtualMachineGroupStatus) {
	*out = *in
	if in.Placement != nil {
		...
		*out = make([]VirtualMachineGroupPlacementStatus, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
